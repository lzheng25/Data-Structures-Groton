...
public class Instruction {
	...
	/**opcode for the ifenemyleft instruction */
	public static final int IFENEMYLEFT=16;
	/**opcode for the ifenemyright instruction */
	public static final int IFENEMYRIGHT=17;
	/**opcode for the ifmemeq instruction */
	public static final int IFMEMEQ=18;
	/**opcode for the copymem instruction */
	...
	public String toString() {
		switch (opcode) {
			...
			case SET:
				return "set "+ address;
			case IFENEMYLEFT:
				return "ifenemyleft "+ address;
			case IFENEMYRIGHT:
				return "ifenemyright "+ address;
			case IFMEMEQ:
				return "ifmemeq "+ testNum + " " + address;
			case COPYMEM:
				return "copymem "+ address;
			default :
